 ...
 * 用于显示和选择当前播放队列中的歌曲
 */
export class QueueModal extends FuzzySuggestModal<TFile> {
	 ...
	 * @param plugin 插件实例
	 * @param playlist 要显示的播放队列（歌曲文件数组）
